import { InvalidTransitionError, ForgeFlowError, failClosed } from './errors.js';
...
export function validateGraphItems(
  ...
  const visit = (key: string): void => {
    if (visiting.has(key)) throw new ForgeFlowError('GRAPH_CYCLE', 'Graph dependency cycle at ' + key);
