...
const root = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '../src/core');
...
test('ForgeFlow core layers stay free of transport, process and legacy coordinator dependencies', () => {
...
test('ForgeFlow external I/O is confined to adapters and never imports legacy coordinator layers', () => {
...
test('ForgeFlow source has explicit safety terms and no credential/header values', () => {
