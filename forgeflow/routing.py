...
def classify_failure_code(code: str) -> FailureClass:
    ...
    if normalized in {
        ...
        "CODEBUDDY_RATE_LIMITED",
        "CODEBUDDY_CAPACITY_BUSY",
        "CODEBUDDY_AUTH_UNAVAILABLE",
        "CODEBUDDY_MODEL_UNAVAILABLE",
        "CODEBUDDY_PROCESS_EXITED",
        "CODEBUDDY_PROBE_RATE_LIMITED",
    ...
    if normalized in {
        ...
        "CODEBUDDY_MAX_CONCURRENCY_INVALID",
