...
def test_failure_classifier_only_marks_route_availability_for_provider_runtime_failures() -> None:
    ...
    assert classify_failure_code("CODEBUDDY_RATE_LIMITED") == "ROUTE_AVAILABILITY"
    assert classify_failure_code("CODEBUDDY_CAPACITY_BUSY") == "ROUTE_AVAILABILITY"
    assert classify_failure_code("CODEBUDDY_AUTH_UNAVAILABLE") == "ROUTE_AVAILABILITY"
    assert classify_failure_code("CODEBUDDY_MODEL_UNAVAILABLE") == "ROUTE_AVAILABILITY"
    assert classify_failure_code("CODEBUDDY_PROCESS_EXITED") == "ROUTE_AVAILABILITY"
    ...
    assert classify_failure_code("CODEBUDDY_MAX_CONCURRENCY_INVALID") == "POLICY_DENIED"
