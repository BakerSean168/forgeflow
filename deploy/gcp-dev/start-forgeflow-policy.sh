...
invariant_ledger_file="$state_dir/invariant-learning.jsonl"
invariant_proposal_file="$state_dir/invariant-proposals.jsonl"
...
export FORGEFLOW_INVARIANT_LEDGER_FILE="$invariant_ledger_file"
export FORGEFLOW_INVARIANT_PROPOSAL_FILE="$invariant_proposal_file"
...
export FORGEFLOW_CODEBUDDY_MODEL="${FORGEFLOW_CODEBUDDY_MODEL:-deepseek-v4.1-flash}"
export FORGEFLOW_CODEBUDDY_MAX_CONCURRENCY="${FORGEFLOW_CODEBUDDY_MAX_CONCURRENCY:-1}"
export FORGEFLOW_CODEBUDDY_INTERNET_ENVIRONMENT="${FORGEFLOW_CODEBUDDY_INTERNET_ENVIRONMENT:-internal}"
export FORGEFLOW_CODEBUDDY_AUTH_STATE_DIR="${FORGEFLOW_CODEBUDDY_AUTH_STATE_DIR:-$HOME/.local/share/CodeBuddyExtension/Data/Public/auth}"
