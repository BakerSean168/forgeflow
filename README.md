...
- **Resource-aware execution** — models/providers are selected through a governed resource directory rather than hard-coded attempt ladders; transient recovery must pass a protocol-correct health probe before a resource re-enters selection, and both ACP execution admission and paid Supervisor admission are demand-driven rather than probing providers while the control plane is idle.
