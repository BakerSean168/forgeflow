...
- [`docs/model-routing-v2-external-agents.md`](./docs/model-routing-v2-external-agents.md) — model-vs-agent routing architecture, production Open SWE→Antigravity fallback, and acceptance evidence.
