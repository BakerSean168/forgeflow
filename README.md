...
- **Resource-aware execution** — models/providers are selected through a governed resource directory rather than hard-coded attempt ladders, and transient recovery must pass a protocol-correct health probe before a resource re-enters selection.
